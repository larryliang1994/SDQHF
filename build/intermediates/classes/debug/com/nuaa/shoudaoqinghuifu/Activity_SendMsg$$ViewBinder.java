...
public class Activity_SendMsg$$ViewBinder<T extends com.nuaa.shoudaoqinghuifu.Activity_SendMsg> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131493070, "field 'ibtn_send' and method 'onClick'");
    target.ibtn_send = finder.castView(view, 2131493070, "field 'ibtn_send'");
    ...
    view = finder.findRequiredView(source, 2131493071, "field 'et_content' and method 'onClick'");
    target.et_content = finder.castView(view, 2131493071, "field 'et_content'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131493072, "field 'll_menu'");
    ...
    view = finder.findRequiredView(source, 2131493074, "method 'onClick'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
